...
public class ListenerSensorImpl implements DeviceListener {
	...
	public void bindThermometerSensor(Thermometer thermometer, Map properties) {
		...
		System.out.println("bind thermometer sensor " + thermometer.getSerialNumber());
	}
	...
	public void unbindThermometerSensor(Thermometer thermometer, Map properties) {
		...
		System.out.println("unbind thermometer sensor " + thermometer.getSerialNumber());	}
	...
	public void bindMotionSensor(MotionSensor motionSensor, Map properties) {
		...
		System.out.println("unbind motionSensor " + motionSensor.getSerialNumber());
	}
	...
	public void devicePropertyModified(GenericDevice device, String propertyName,
		...
		System.out.println("devicePropertyModified called on device: " + device + " with property: " + propertyName + " old value: " + oldValue + " and new value: " + newValue);
